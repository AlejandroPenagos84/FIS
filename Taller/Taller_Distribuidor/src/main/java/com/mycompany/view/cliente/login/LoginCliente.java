package com.mycompany.view.cliente.login;
...
public class LoginCliente extends JFrame {
    ...
    public LoginCliente(ClienteController clienCont) {
        ...
        usuarioField.setText("juanp");
        contraseñaField.setText("1234");
        ...
        loginButton.addActionListener(e -> {
            ...
            try {
                clienCont.login(usuario, contraseña);

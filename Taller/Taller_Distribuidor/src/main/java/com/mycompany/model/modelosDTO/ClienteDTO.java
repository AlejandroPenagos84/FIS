...
public class ClienteDTO {
    ...
    private double v_limite_credito;
    ...
    public ClienteDTO(String k_cod_cliente, String n_nombre_cliente, String dir_calle, String dir_carrera, String dir_numero, double v_saldo, double v_limite_credito, Double v_porcentaje_de_descuento, String cre_usuario_cliente, String cre_contrasena_cliente) {
    ...
    public double getV_limite_credito() {
        return v_limite_credito;
    }

    public void setV_limite_credito(double v_limite_credito) {
        this.v_limite_credito = v_limite_credito;
    }
